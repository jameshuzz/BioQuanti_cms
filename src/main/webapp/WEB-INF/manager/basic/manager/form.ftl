    ...
    <el-dialog  :append-to-body="true" id="form" v-model="dialogVisible"  :close-on-click-modal="false" width="50%" v-cloak>
        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="120px" size="default">
            <el-form-item  label="管理员账号" prop="managerName">
                ...
                <div class="ms-form-tip">管理员账号必须填写，长度为6-15个字符！</div>
            </el-form-item>
            ...
            <el-form-item  label="管理员昵称" prop="managerNickName">
                ...
                <div class="ms-form-tip">管理员昵称必须填写，长度为1-15个字符！</div>
            </el-form-item>
                ...
                rules: {
                    ...
                    managerName: [{
                        ...
                        validator: function (rule, value, callback) {
                            if (/^[a-zA-Z0-9_]{6,15}$/.exec(value) == null) {
                                callback('管理员帐号只能由英文字母，数字，下划线组成，且长度为6-15个字符！')
                            }
                            callback();
                        },
                        trigger: ['change']
