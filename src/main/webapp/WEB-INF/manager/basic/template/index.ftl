    ...
    <el-header class="ms-header" height="50px">
        ...
        <el-col :span=2>
            <el-upload
                ...
                <el-button size="default" class="el-icon-upload2" type="primary" :loading="uploadLoading">上传模板ZIP压缩包</el-button>
                </el-tooltip>
            </el-upload>
        </el-col>
        </@shiro.hasPermission>
    ...
    var indexVue = new _Vue({
        ...
        methods: {
            ...
            view: function (name) {
                ...
                // 传递模板文件夹名称 方便form页面获取
                ms.util.openSystemUrl("/basic/template/form.do?template=" + name);
            },
            //表格数据转换
            //pageSize改变时会触发
