...
<script>
    var form = new _Vue({
        ...
        methods: {
            back: function () {
                ms.util.openSystemUrl("/mdiy/dict/index.do?dictType=" + this.form.dictType,true);
            },
            save: function () {
                var that = this;
                    ...
                    if (valid) {
                        ...
                        ms.http.post(url, data).then(function (data) {
                            if (data.result) {
                                ...
                                ms.util.openSystemUrl("/mdiy/dict/index.do?dictType=" + that.form.dictType,that.form.id > 0);
                            } else {
                                that.$notify({
                                    title: '失败',
                                    message: data.msg,
